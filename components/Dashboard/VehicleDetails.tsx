      ...
      <div className="p-4 border-b border-[var(--card-border)] flex justify-between items-center sticky top-0 bg-[var(--card-bg)] z-10">
        <div>
          <div className="flex items-center gap-2">
            ...
            {vehicle.lastExternalUpdate && (new Date().getTime() - vehicle.lastExternalUpdate.toDate().getTime() < 300000) ? (
              <span className="bg-green-500/20 text-green-400 text-[10px] px-1.5 py-0.5 rounded uppercase font-bold tracking-wider animate-pulse">
                Live Sensor
              </span>
            ) : (
              <span className="bg-gray-500/20 text-gray-400 text-[10px] px-1.5 py-0.5 rounded uppercase font-bold tracking-wider">
                Simulated / Offline
              </span>
            )}
          </div>
